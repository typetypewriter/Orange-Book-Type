...
// 全书目录
#let my-outline(preface-state, preface-state-hide-parent, appendix-state, appendix-state-hide-parent, part-state, part-location, part-change, part-counter, outline-font1, main-color, textSize1:none, textSize2:none, textSize3:none, textSize4:none) = {
  show outline.entry: it => {
    ...
    if it.level == 1 {
      ...
      else if (counterInt.first() == 1 and preface-state != none and not preface-state-hide-parent ){
...
// 部分目录
#let my-outline-small(partTitle, appendix-state, part-state, part-location,part-change,part-counter, outline-font1, main-color, textSize1:none, textSize2:none, textSize3:none, textSize4:none) = {
  show outline.entry: it => {
    let appendix-state = appendix-state.at(it.element.location())
